...
public class InternalMethLexer extends Lexer {
    ...
    public final void mT__17() throws RecognitionException {
        try {
            int _type = T__17;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:15:7: ( 'Einheitensystem' )
            // InternalMeth.g:15:9: 'Einheitensystem'
            {
    ...
    public final void mT__20() throws RecognitionException {
        try {
            int _type = T__20;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:18:7: ( 'Dimension' )
            // InternalMeth.g:18:9: 'Dimension'
            {
            match("Dimension"); 
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:23:7: ( 'Einheit' )
            // InternalMeth.g:23:9: 'Einheit'
            {
            match("Einheit"); 
    ...
    public final void mT__26() throws RecognitionException {
        try {
            int _type = T__26;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:24:7: ( 'in' )
            // InternalMeth.g:24:9: 'in'
            {
            match("in"); 
    ...
    public final void mT__27() throws RecognitionException {
        try {
            int _type = T__27;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:25:7: ( 'Umrechnung' )
            // InternalMeth.g:25:9: 'Umrechnung'
            {
            match("Umrechnung"); 
    ...
    public final void mT__28() throws RecognitionException {
        try {
            int _type = T__28;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:26:7: ( 'Konstante' )
            // InternalMeth.g:26:9: 'Konstante'
            {
            match("Konstante"); 
    ...
    public final void mT__35() throws RecognitionException {
        try {
            int _type = T__35;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:33:7: ( 'aus' )
            // InternalMeth.g:33:9: 'aus'
            {
            match("aus"); 
    ...
    public final void mRULE_GANZ() throws RecognitionException {
        try {
            int _type = RULE_GANZ;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:4677:11: ( ( '+' | '-' )? RULE_INT ( '_' RULE_INT )* )
            // InternalMeth.g:4677:13: ( '+' | '-' )? RULE_INT ( '_' RULE_INT )*
            {
            // InternalMeth.g:4677:13: ( '+' | '-' )?
            int alt1=2;
            ...
            mRULE_INT(); 
            // InternalMeth.g:4677:33: ( '_' RULE_INT )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalMeth.g:4677:34: '_' RULE_INT
            	    {
            	    match('_'); 
            	    mRULE_INT(); 
    ...
    public final void mRULE_DEZIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:4679:14: ( ( '+' | '-' )? RULE_INT ( '_' RULE_INT )* '.' ( RULE_INT ( '_' RULE_INT )* )? ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT ( '_' RULE_INT )* )? )
            // InternalMeth.g:4679:16: ( '+' | '-' )? RULE_INT ( '_' RULE_INT )* '.' ( RULE_INT ( '_' RULE_INT )* )? ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT ( '_' RULE_INT )* )?
            {
            // InternalMeth.g:4679:16: ( '+' | '-' )?
            int alt3=2;
            ...
            mRULE_INT(); 
            // InternalMeth.g:4679:36: ( '_' RULE_INT )*
            loop4:
            do {
                int alt4=2;
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalMeth.g:4679:37: '_' RULE_INT
            	    {
            	    match('_'); 
            	    mRULE_INT(); 
            ...
            match('.'); 
            // InternalMeth.g:4679:56: ( RULE_INT ( '_' RULE_INT )* )?
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalMeth.g:4679:57: RULE_INT ( '_' RULE_INT )*
                    {
                    mRULE_INT(); 
                    // InternalMeth.g:4679:66: ( '_' RULE_INT )*
                    loop5:
                    do {
                        int alt5=2;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalMeth.g:4679:67: '_' RULE_INT
                    	    {
                    	    match('_'); 
                    	    mRULE_INT(); 
            ...
            // InternalMeth.g:4679:84: ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT ( '_' RULE_INT )* )?
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalMeth.g:4679:85: ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT ( '_' RULE_INT )*
                    {
                    ...
                    mRULE_INT(); 
                    // InternalMeth.g:4679:115: ( '_' RULE_INT )*
                    loop8:
                    do {
                        int alt8=2;
                        ...
                        switch (alt8) {
                    	case 1 :
                    	    // InternalMeth.g:4679:116: '_' RULE_INT
                    	    {
                    	    match('_'); 
                    	    mRULE_INT(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:4681:9: ( ( '$' | '\\u20AC' | ( '^' )? ( '\\u00B5' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '\\u00B0' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( '\\u00B2' | '\\u00B3' )? ) )
            // InternalMeth.g:4681:11: ( '$' | '\\u20AC' | ( '^' )? ( '\\u00B5' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '\\u00B0' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( '\\u00B2' | '\\u00B3' )? )
            {
            // InternalMeth.g:4681:11: ( '$' | '\\u20AC' | ( '^' )? ( '\\u00B5' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '\\u00B0' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( '\\u00B2' | '\\u00B3' )? )
            int alt14=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt14) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // InternalMeth.g:4681:25: ( '^' )? ( '\\u00B5' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '\\u00B0' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( '\\u00B2' | '\\u00B3' )?
                    {
                    // InternalMeth.g:4681:25: ( '^' )?
                    int alt10=2;
                    ...
                    // InternalMeth.g:4681:73: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
                    loop12:
                    do {
                        int alt12=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalMeth.g:4683:19: ( ( '0' .. '9' )+ )
            // InternalMeth.g:4683:21: ( '0' .. '9' )+
            {
            // InternalMeth.g:4683:21: ( '0' .. '9' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:4685:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMeth.g:4685:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMeth.g:4685:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalMeth.g:4685:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMeth.g:4685:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop16:
                    do {
                        int alt16=3;
                        ...
                        switch (alt16) {
                    	case 1 :
                    	    // InternalMeth.g:4685:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    ...
                    break;
                case 2 :
                    // InternalMeth.g:4685:86: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMeth.g:4685:91: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop17:
                    do {
                        int alt17=3;
                        ...
                        switch (alt17) {
                    	case 1 :
                    	    // InternalMeth.g:4685:92: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:4687:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMeth.g:4687:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMeth.g:4687:24: ( options {greedy=false; } : . )*
            loop19:
            do {
                int alt19=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:4689:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMeth.g:4689:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMeth.g:4689:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop20:
            do {
                int alt20=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:4691:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMeth.g:4691:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMeth.g:4691:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt23=0;
            loop23:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMeth.g:4693:16: ( . )
            // InternalMeth.g:4693:18: .
            {
            matchAny(); 
    ...
    static final String DFA24_eotS =
        "\2\uffff\1\45\1\46\1\50\1\52\2\uffff\1\52\4\uffff\10\52\2\uffff\1\52\1\76\2\uffff\2\41\1\uffff\2\41\7\uffff\1\76\1\uffff\1\52\3\uffff\1\52\4\uffff\1\105\10\52\2\uffff\1\52\5\uffff\2\52\1\uffff\3\52\1\126\1\127\4\52\1\76\6\52\2\uffff\3\52\1\145\11\52\1\uffff\11\52\1\171\1\172\3\52\1\176\1\177\1\52\1\u0081\1\52\2\uffff\3\52\2\uffff\1\52\1\uffff\1\52\1\u0088\1\52\1\u008a\2\52\1\uffff\1\u008d\1\uffff\1\u008e\1\52\2\uffff\3\52\1\u0093\1\uffff";
    static final String DFA24_eofS =
        "\u0094\uffff";
    static final String DFA24_minS =
        "\1\0\1\uffff\1\52\2\60\1\151\2\uffff\1\151\4\uffff\1\156\1\155\1\157\1\145\1\154\2\145\1\165\2\uffff\1\117\1\56\2\uffff\2\101\1\uffff\2\0\7\uffff\1\56\1\uffff\1\156\3\uffff\1\155\4\uffff\1\60\1\162\1\156\1\164\2\163\1\147\1\162\1\163\2\uffff\1\104\1\uffff\1\60\3\uffff\1\147\1\145\1\uffff\1\145\1\163\1\150\2\60\2\145\1\147\1\117\1\56\1\145\1\141\1\156\1\143\1\164\1\157\2\uffff\1\142\1\143\1\141\1\60\1\151\1\142\1\163\1\150\1\141\1\144\1\145\1\150\1\142\1\uffff\1\164\1\145\1\151\2\156\1\145\2\156\1\145\2\60\1\157\1\165\1\164\2\60\1\165\1\60\1\156\2\uffff\2\156\1\145\2\uffff\1\156\1\uffff\1\163\1\60\1\147\1\60\1\147\1\171\1\uffff\1\60\1\uffff\1\60\1\163\2\uffff\1\164\1\145\1\155\1\60\1\uffff";
